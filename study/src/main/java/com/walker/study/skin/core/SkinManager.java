...
public class SkinManager extends Observable {
     ...
     * Activity生命周期回调
     */
    private SkinApplicationActivityLifecycle skinActivityLifecycle;
    ...
    private SkinManager(Application application) {
        ...
        skinActivityLifecycle = new SkinApplicationActivityLifecycle(this);
...
//
                ...
                LogHelper.get().e("SkinManager", e.getMessage());
            }
        }
        //通知采集的View 更新皮肤
        //被观察者改变 通知所有观察者
